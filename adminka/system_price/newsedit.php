<?php
  ...
  try
  {
	...
	$arr_razdels = array();
	while ($razdels = mysql_fetch_array($adr)){
		$arr_razdels[$razdels['id']] = $razdels['title'];
	}
	...
	$price       = new field_text("price",
                                  ...
                                  true,
                                  $_REQUEST['price']);
	$code        = new field_text("code",
                                  "Код продукта",
                                  true,
                                  $_REQUEST['code']);
	$razdelID      = new field_select("razdelID",
                                  "Раздел",
                                  $arr_razdels,
                                  $_REQUEST['razdelID']);
    ...
    if(!empty($_POST))
    {
      ...
      if(empty($error))
      {
        ...
        $query = "UPDATE $tbl_tovar 
                  SET razdelID = '{$form->fields['razdelID']->value}',
